...
function EvaluationWithDescription() {
  return (
    <Form>
      <h5 className="mb-4">
      ...
      <Row>
        <Col md={6}>
          ...
          <Form.Group disabled required className="mb-3" controlId="birthday">
            <Form.Label>
              <b>PESEL</b>
            </Form.Label>
            <Form.Control disabled required type="number" placeholder="PESEL" />
          </Form.Group>
        ...
        <Col>
          ...
          <Form.Group className="mb-3" controlId="basic">
            ...
            <Form.Control disabled required type="text" placeholder="Miasto" />
          </Form.Group>
          <Form.Group className="mb-3" controlId="basic">
            <Form.Label>
              <b>Kod pocztowy</b>
      ...
      <Row>
        ...
        <Col md={6} lg={4} className="mt-md-4 mt-lg-0">
          ...
          />
          <Form.Check type="radio" name="diagnoza" disabled label={`brak`} />
        </Col>
      </Row>
      <Row>
        <Col>
          ...
          <Form.Group className="mb-3 mt-3" controlId="exampleForm.ControlTextarea1">
            <Form.Label><b>Dodaj opis</b></Form.Label>
...
export default EvaluationWithDescription;
